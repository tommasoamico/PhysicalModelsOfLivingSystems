...
class mpl2latex():
    ...
    def __init__(self, back_flag, packages=None, backend='pgf', SMALL_SIZE=8, MEDIUM_SIZE=10, BIGGER_SIZE=11, BIGGEST_SIZE=12):
        ...
        # Necessary to create a copy, not a reference
        self.original_rcParams = deepcopy(matplotlib.rcParams)
    ...
    def __enter__(self):
        ...
        if self.back_flag:
            ...
            plt.rc('axes', labelsize=self.SMALL_SIZE)
            # fontsize of the tick labels
            plt.rc('xtick', labelsize=self.SMALL_SIZE)
            # fontsize of the tick labels
            plt.rc('ytick', labelsize=self.SMALL_SIZE)
            plt.rc('legend', fontsize=self.MEDIUM_SIZE)    # legend fontsize
            # fontsize of the figure title
            plt.rc('figure', titlesize=self.BIGGEST_SIZE)
